...
curDayIcon = document.querySelectorAll(".wrapper ul"); // creating days icons
...
const renderCalendar = () => {
    ...
    let liTag = "";
    for (let k = firstDayofMonth; k > 0; k--) { // creating li of previous month last days
        liTag += `<li class="inactive">${lastDateofLastMonth - k + 1}</li>`;
    }
